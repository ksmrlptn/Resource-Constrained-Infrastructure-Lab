...
The Resource-Constrained Infrastructure Lab (RCIL) is a personal hands-on infrastructure project focused on developing practical Systems Support, Networking, Troubleshooting, and Systems Administration skills using limited and repurposed hardware.
...
- Lenovo ThinkPad Yoga 11e 3rd Gen (administrative system)
- Jumpertech EZBook S5 (primary infrastructure node)
- Oppo A3S smartphone (USB tethering network bridge)
...
The environment currently operates under several hardware limitations:
